...
#define SC_IS_PROVIDER_CSYMBOLS(obj) (G_TYPE_CHECK_INSTANCE_TYPE ((obj), SC_TYPE_PROVIDER_CSYMBOLS_GOTO))
#define SC_IS_PROVIDER_CSYMBOLS_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), SC_TYPE_PROVIDER_CSYMBOLS_GOTO))
